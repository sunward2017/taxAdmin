<template>
	<div>
		<el-table :data="rows" style="width: 98%">
      <el-table-column type="index" label="列号" width="100"></el-table-column>
			...
			<el-table-column inline-template :context="_self" label="操作" align='center'>
				<span>
					...
					<el-button v-show="isDelete" type="warning" icon="delete" size="small" @click="handleDel(row)">删除</el-button>
					<el-button v-show="isSpecial" type="success" size="small" @click="handleSpecail(row)">音视频交互</el-button>
					<!--<el-button  type="info" size="small" @click="handleLog(row)">运行日志</el-button>-->
