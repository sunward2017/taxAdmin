    ...
    <el-dialog :title="editFormTtile" v-model="editFormVisible" :close-on-click-modal="false" size="tiny" @close="resetForm">
      <el-form :model="editForm" label-width="90px" :rules="editFormRules" ref="editForm">
        <el-form-item label="包名称" prop="packageName">
          <el-input v-model="editForm.packageName" auto-complete="off" style="width: 60%"></el-input>
        </el-form-item>
        <el-form-item label="版本名称" prop="versionName">
          <el-input v-model="editForm.versionName" auto-complete="off"  style="width: 60%"> </el-input>
        </el-form-item>
        <el-form-item label="版本号" prop="versionCode">
          <el-input v-model="editForm.versionCode" auto-complete="off"  style="width: 60%"></el-input>
        </el-form-item>
        <el-form-item label="版本描述" prop="versionDescription">
          <el-input v-model="editForm.versionDescription" auto-complete="off"  style="width: 60%"></el-input>
        </el-form-item>
        <el-form-item label="是否保存">
          <el-radio class="radio" v-model="this.editForm.status" label="1">保存</el-radio>
          <el-radio class="radio" v-model="this.editForm.status" label="0">不保存</el-radio>
        </el-form-item>

        <el-form-item label="版本文件" >
          <!--<Upload  :url="url" strRegExp=".APK" ref="uploadApk" @callback="getManger" :fileList="fileList" @test="test" @resp_res="upload"/>-->
          <Upload :param="editForm" :url="url" strRegExp=".APK" ref="uploadApk" @callback="getManger" :fileList="fileList" @test="test" @resp_res="upload"/>
        </el-form-item>

        <!--<el-form-item label="版本文件" v-if="!editForm.Action">-->
          <!--<Upload  :url="url" strRegExp=".APK" ref="uploadApk" @callback="getManger" :fileList="fileList"/>-->
          <!--&lt;!&ndash;<Upload :param="editForm" :url="url" strRegExp=".APK" ref="uploadApk" @callback="getManger" :fileList="fileList"/>&ndash;&gt;-->
        <!--</el-form-item>-->

      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click.native="cancel"  icon="circle-cross">取 消</el-button>
        <el-button @click.native="submit" icon="upload2" type="info">保存</el-button>
        <!--<el-button @click.native="complete" icon="check"  type="success">完成</el-button>-->
...
//  import Upload from "../../components/Upload/indexCopy";
